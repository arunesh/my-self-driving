...
# No need to fix datapath since we are running on a local machine.
...
def preprocess_samples(samples):
    ...
    for line in samples:
        ...
        left_image_read = cv2.cvtColor(left_image_read, cv2.COLOR_BGR2RGB)
        ...
        right_image_read = cv2.cvtColor(right_image_read, cv2.COLOR_BGR2RGB)
...
lines = []
# Include any additional directories here. This allows us to dynamically combine various
# datasets.
data_dirs = ["/home/arunesh/nd/BC-Project/d2", "/home/arunesh/nd/BC-Project/d4"]
for ddir in data_dirs:
    csv_file = ddir + "/driving_log.csv"
